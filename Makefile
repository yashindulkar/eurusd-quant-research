...
.PHONY: setup validate-environment format lint typecheck test test-unit test-integration coverage check register-data audit-raw-data generate-coverage prepare-task04-v25-integrity prepare-task04-v25-registration validate-task04-v25-schemas create-task04-registration-receipt validate-task04-registration-receipt validate-task04-preregistration generate-task04-candidate reconcile-task04-v25
...
prepare-task04-v25-integrity:
	$(PYTHON) scripts/prepare_task04_v25_integrity_evidence.py

prepare-task04-v25-registration:
	$(PYTHON) scripts/prepare_task04_v25_registration.py

validate-task04-v25-schemas:
	$(PYTHON) scripts/validate_task04_v25_schemas.py
...
reconcile-task04-v25:
	$(PYTHON) scripts/reconcile_task04_v25.py
