"""Create the v2.6 pre-anchor registration and executable configuration."""
...
def _registered_paths(source_paths: tuple[str, ...]) -> list[str]:
    paths = {
        *source_paths,
        ...
        "studies/task03_task04_v2.6_mask_evidence.json",
        "studies/task04_daily_range_weekday.v2.6.yaml",
        "studies/task04_development_baseline.json",
        "studies/task04_v2.6_environment_lock.json",
        "studies/task04_v2.6_source_manifest.json",
    }
    return sorted(paths)
...
def main() -> int:
    ...
    base.update(
        {
            ...
            "implementation_version": "task04-daily-range-weekday-v2.6",
    ...
    if "daily_profile_observations.csv" not in base["expected_outputs"]["files"]:
        base["expected_outputs"]["files"].insert(5, "daily_profile_observations.csv")
    ...
    base["repository_lineage"].update(
        {
            "registration_receipt_path": (
                "studies/task04_daily_range_weekday.v2.6.receipt.json"
            ),
            "registration_lifecycle_path": (
                "studies/task04_daily_range_weekday.v2.6.lifecycle.json"
            ),
            "source_manifest_path": "studies/task04_v2.6_source_manifest.json",
            "environment_lock_path": "studies/task04_v2.6_environment_lock.json",
            "registered_path_inventory": paths,
            "dirty_state_policy": (
                "Every registered path must be tracked and byte-identical to its "
                "v2.6 anchor blob. Additional files in the declared source scope "
    ...
    base["deviation_policy"]["rule"] = (
        ...
        "registration version and Git anchor. The v2.6 deviation list is locked "
    ...
    base["production_governance"] = {
        ...
        "candidate_output_directory": "reports/research/.task04_v2.6_candidate",
        "final_output_directory": ("reports/research/task04_daily_range_weekday_v2.6"),
        ...
        "candidate_csv_loading_policy": (
            "SCHEMA_DRIVEN_PRESERVE_REGISTERED_EMPTY_STRINGS"
        ),
        "exclusion_reasons_empty_value": "EMPTY_STRING",
        "exclusion_reasons_null_policy": "NULL_INVALID",
        "regime_lineage_comparison_fields": [
            "utc_date",
            "profile",
            "daily_range_pips",
        ...
        "output_path_convention": "PRODUCTION_ROOT_RELATIVE_FORWARD_SLASH",
        "figure_path_prefix": "figures/",
        "mismatch_treatment": ("ZERO_CATEGORICAL_MEMBERSHIP_AND_INVENTORY_TOLERANCE"),
        "independent_reconciliation_components": [
            "source_population",
            "daily_aggregation",
        ...
        "categorical_mismatch_tolerance": 0,
        "membership_mismatch_tolerance": 0,
        "inventory_mismatch_tolerance": 0,
        "unchecked_component_policy": "NOT_CHECKED_CAUSES_OVERALL_FAILURE",
        "independent_rating_reconstruction_required": True,
    ...
    registration_path = root / "studies" / "task04_daily_range_weekday.v2.6.yaml"
    ...
    active.update(
        {
            ...
            "output_directory": ("reports/research/task04_daily_range_weekday_v2.6"),
            "candidate_output_directory": ("reports/research/.task04_v2.6_candidate"),
            ...
            "exclusion_reasons_empty_value": "EMPTY_STRING",
            "exclusion_reasons_null_policy": "NULL_INVALID",
            "regime_lineage_comparison_fields": base["production_governance"][
                "regime_lineage_comparison_fields"
            ],
            "output_path_convention": "PRODUCTION_ROOT_RELATIVE_FORWARD_SLASH",
            "figure_path_prefix": "figures/",
            "mismatch_treatment": (
                "ZERO_CATEGORICAL_MEMBERSHIP_AND_INVENTORY_TOLERANCE"
            ),
            "independent_reconciliation_components": base["production_governance"][
                "independent_reconciliation_components"
            ],
            "categorical_mismatch_tolerance": 0,
            "membership_mismatch_tolerance": 0,
            ...
            "unchecked_component_policy": "NOT_CHECKED_CAUSES_OVERALL_FAILURE",
            "independent_rating_reconstruction_required": True,
            "expected_output_files": base["expected_outputs"]["files"],
            "maximum_numerical_discrepancy_tolerance": 1e-10,
            "minimum_branch_coverage_percent": 90.0,
    ...
    print(
        "Task 04 v2.6 preregistration: ANCHOR_READY | "
