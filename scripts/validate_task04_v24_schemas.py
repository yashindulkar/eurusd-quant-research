"""Validate v2.4 registration and governance schemas without creating evidence."""
...
def main() -> int:
    ...
    if registration.status != "PREREGISTERED":
        raise ValueError("v2.4 registration is not PREREGISTERED")
    print("Task 04 v2.4 governance schemas: PASS")
    return 0
