"""Create the v2.5 pre-anchor registration and executable configuration."""
...
def _registered_paths(source_paths: tuple[str, ...]) -> list[str]:
    paths = {
        *source_paths,
        ...
        "studies/task04_daily_range_weekday.v2.5.yaml",
        "studies/task04_development_baseline.json",
        "studies/task04_v2.5_environment_lock.json",
        "studies/task04_v2.5_source_manifest.json",
    }
    return sorted(paths)
...
def main() -> int:
    ...
    environment_path = root / "studies" / "task04_v2.5_environment_lock.json"
    ...
    base.update(
        {
            ...
            "implementation_version": "task04-daily-range-weekday-v2.5",
    ...
    base["expected_outputs"]["directory"] = (
        "reports/research/task04_daily_range_weekday_v2.5"
    )
    ...
    base["repository_lineage"].update(
        {
            ...
            "source_manifest_path": "studies/task04_v2.5_source_manifest.json",
            "environment_lock_path": "studies/task04_v2.5_environment_lock.json",
            "registered_path_inventory": paths,
            "dirty_state_policy": (
                "Every registered path must be tracked and byte-identical to its "
                "v2.5 anchor blob. Additional files in the declared source scope "
    ...
    base["deviation_policy"]["rule"] = (
        ...
        "registration version and Git anchor. The v2.5 deviation list is locked "
    ...
    base["production_governance"] = {
        ...
        "candidate_output_directory": "reports/research/.task04_v2.5_candidate",
        "final_output_directory": ("reports/research/task04_daily_range_weekday_v2.5"),
    ...
    registration_path = root / "studies" / "task04_daily_range_weekday.v2.5.yaml"
    ...
    active.update(
        {
            ...
            "output_directory": ("reports/research/task04_daily_range_weekday_v2.5"),
            "candidate_output_directory": ("reports/research/.task04_v2.5_candidate"),
    ...
    print(
        "Task 04 v2.5 preregistration: ANCHOR_READY | "
