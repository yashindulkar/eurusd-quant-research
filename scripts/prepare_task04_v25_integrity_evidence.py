"""Prepare pre-result v2.5 dependency evidence without Task 04 calculation."""
...
def _environment_lock() -> dict[str, object]:
    return {
        ...
        "policy": (
            "Exact versions for the registered v2.5 candidate-generation and "
