"""Validate v2.6 registration and governance schemas without creating evidence."""
...
def main() -> int:
    ...
    if registration.status != "PREREGISTERED":
        raise ValueError("v2.6 registration is not PREREGISTERED")
    print("Task 04 v2.6 governance schemas: PASS")
    return 0
