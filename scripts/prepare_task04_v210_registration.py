"""Create the v2.10 pre-anchor registration and executable configuration."""
    ...
    return sorted(
        {
            *source_paths,
            ...
            "studies/task03_task04_v2.10_evidence.json",
            "studies/task04_daily_range_weekday.v2.10.yaml",
            "studies/task04_development_baseline.json",
            "studies/task04_v2.10_environment_lock.json",
            "studies/task04_v2.10_source_manifest.json",
            "studies/task04_v2.9_stopped_attempt.json",
        }
    )
...
def main() -> int:
    ...
    environment_path = root / "studies/task04_v2.10_environment_lock.json"
    ...
    base.update(
        {
            ...
            "implementation_version": "task04-daily-range-weekday-v2.10",
    ...
    task03_dependency.update(
        {
            "evidence_path": "studies/task03_task04_v2.10_evidence.json",
    ...
    base["expected_outputs"]["directory"] = (
        "reports/research/task04_daily_range_weekday_v2.10"
    )
    ...
    base["repository_lineage"].update(
        {
            ...
            "source_manifest_path": "studies/task04_v2.10_source_manifest.json",
            "environment_lock_path": "studies/task04_v2.10_environment_lock.json",
            "registered_path_inventory": paths,
            "dirty_state_policy": (
                "Every registered path must be tracked and byte-identical to its "
                "v2.10 anchor blob. Post-anchor receipt, candidate, reconciliation, "
    ...
    base["deviation_policy"]["rule"] = (
        ...
        "The v2.10 deviation list is locked empty and is not appendable."
    )
    ...
    governance.update(
        {
            ...
            "candidate_output_directory": "reports/research/.task04_v2.10_candidate",
    ...
    registration_path = root / "studies/task04_daily_range_weekday.v2.10.yaml"
    ...
    active.update(
        {
            ...
            "receipt_schema_version": "task04-registration-receipt-v6",
            "lifecycle_schema_version": "task04-registration-lifecycle-v6",
            "preregistration_path": "studies/task04_daily_range_weekday.v2.10.yaml",
            "registration_receipt_path": (
                "studies/task04_daily_range_weekday.v2.10.receipt.json"
            ),
            "registration_lifecycle_path": (
            ...
            "environment_lock_path": "studies/task04_v2.10_environment_lock.json",
            "task03_evidence_path": "studies/task03_task04_v2.10_evidence.json",
            "task03_evidence_layer_schema_version": task03.schema_version,
            ...
            "output_directory": "reports/research/task04_daily_range_weekday_v2.10",
            "candidate_output_directory": "reports/research/.task04_v2.10_candidate",
            "validated_candidate_identity_path": (
                "studies/task04_v2.10_validated_candidate_identity.json"
            ),
    ...
    print(
        "Task 04 v2.10 preregistration: ANCHOR_READY | "
