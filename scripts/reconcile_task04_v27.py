"""Build full independent Task 04 v2.7 reconciliation evidence after generation."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    path = (
        arguments.output or root / "studies/task04_v2.7_independent_reconciliation.json"
    )
    _write_once(path, evidence.model_dump(mode="json"))
    print(
        "Task 04 v2.7 independent reconciliation: PASS | "
