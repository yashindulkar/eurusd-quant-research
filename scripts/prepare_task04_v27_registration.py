"""Create the v2.7 pre-anchor registration and executable configuration."""
    ...
    return sorted(
        {
            *source_paths,
            ...
            "studies/task03_task04_v2.7_evidence.json",
            "studies/task04_daily_range_weekday.v2.7.yaml",
            "studies/task04_development_baseline.json",
            "studies/task04_v2.7_environment_lock.json",
            "studies/task04_v2.7_source_manifest.json",
        }
    )
...
def main() -> int:
    ...
    environment_path = root / "studies/task04_v2.7_environment_lock.json"
    ...
    base.update(
        {
            ...
            "implementation_version": "task04-daily-range-weekday-v2.7",
    ...
    task03_dependency.update(
        {
            "evidence_path": "studies/task03_task04_v2.7_evidence.json",
    ...
    base["repository_lineage"].update(
        {
            ...
            "source_manifest_path": "studies/task04_v2.7_source_manifest.json",
            "environment_lock_path": "studies/task04_v2.7_environment_lock.json",
            "registered_path_inventory": paths,
            "dirty_state_policy": (
                "Every registered path must be tracked and byte-identical to its "
                "v2.7 anchor blob. Post-anchor receipt, candidate, reconciliation, "
    ...
    base["deviation_policy"]["rule"] = (
        ...
        "The v2.7 deviation list is locked empty and is not appendable."
    )
    ...
    governance.update(
        {
            ...
            "candidate_output_directory": "reports/research/.task04_v2.7_candidate",
    ...
    registration_path = root / "studies/task04_daily_range_weekday.v2.7.yaml"
    ...
    active.update(
        {
            ...
            "receipt_schema_version": "task04-registration-receipt-v5",
            "lifecycle_schema_version": "task04-registration-lifecycle-v5",
            "preregistration_path": "studies/task04_daily_range_weekday.v2.7.yaml",
            "registration_receipt_path": (
                "studies/task04_daily_range_weekday.v2.7.receipt.json"
            ),
            "registration_lifecycle_path": (
            ...
            "environment_lock_path": "studies/task04_v2.7_environment_lock.json",
            "task03_evidence_path": "studies/task03_task04_v2.7_evidence.json",
            "task03_evidence_layer_schema_version": task03.schema_version,
            ...
            "output_directory": "reports/research/task04_daily_range_weekday_v2.7",
            "candidate_output_directory": "reports/research/.task04_v2.7_candidate",
    ...
    print(
        "Task 04 v2.7 preregistration: ANCHOR_READY | "
