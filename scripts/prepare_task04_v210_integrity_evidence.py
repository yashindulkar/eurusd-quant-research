"""Prepare pre-result v2.10 dependency evidence without Task 04 calculation."""
...
def _environment_lock() -> dict[str, object]:
    return {
        ...
        "policy": (
            "Exact versions for the registered v2.10 candidate-generation and "
...
def main() -> int:
    ...
    print(
        ...
        f"scientific={task03_evidence.scientific_membership_fingerprint} | "
        f"stable_artifact={task03_evidence.stable_artifact_fingerprint} | "
        f"execution_context={task03_evidence.execution_context_fingerprint}"
    )
    return 0
